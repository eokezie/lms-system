...
export async function register(dto: RegisterDto): Promise<{ user: IUser; tokens: AuthTokens }> {
...
export async function login(dto: LoginDto): Promise<{ user: IUser; tokens: AuthTokens }> {
